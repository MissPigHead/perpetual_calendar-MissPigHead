                        ...
                        <form action="index.php" method="get">
                            <div class="form-row d-flex justify-content-center align-items-center">
                                <div class="input-group order-1 order-md-2 col-12 col-md-3 my-2">
                                    ...
                                    <input type="number" min="1900" max="10000" class="form-control" placeholder="<?=date("Y");?>" name="Yr">
                                </div>
                                <div class="input-group order-2 order-md-3 col-12 col-md-3 my-2">
                                    ...
                                    <select name="Mn" class="form-control">
                                        <option value="1"  <?=(date("m")==1)?'selected':"";?>> 1 </option>
                                        <option value="2"  <?=(date("m")==2)?'selected':"";?>> 2 </option>
                                        <option value="3"  <?=(date("m")==3)?'selected':"";?>> 3 </option>
                                        <option value="4"  <?=(date("m")==4)?'selected':"";?>> 4 </option>
                                        <option value="5"  <?=(date("m")==5)?'selected':"";?>> 5 </option>
                                        <option value="6"  <?=(date("m")==6)?'selected':"";?>> 6 </option>
                                        <option value="7"  <?=(date("m")==7)?'selected':"";?>> 7 </option>
                                        <option value="8"  <?=(date("m")==8)?'selected':"";?>> 8 </option>
                                        <option value="9"  <?=(date("m")==9)?'selected':"";?>> 9 </option>
                                ...
                                <div class="order-3 order-md-1 col-4 col-md-1 mr-md-4 my-2">
                                    <button type="button" class="btn btn-icon-cus col-12"
                                        ...
                                        ?>
                                        onclick="location.href='index.php?Yr=<?=$lastYr;?>&Mn=<?=$lastMn;?>'">
                                ...
                                <div class="order-5 col-4 col-md-1 ml-md-4 my-2">
                                    <button type="button" class="btn btn-icon-cus col-12"
                                        ...
                                        ?>
                                        onclick="location.href='index.php?Yr=<?=$nextYr;?>&Mn=<?=$nextMn;?>'">
