...
$motto = array(
  ...
  array('id' => '104','saying' => 'A pessimist is one who makes difficulties of his opportunities and an optimist is one who makes opportunities of his difficulties.','person' => 'Harry S. Truman'),
  ...
  array('id' => '118','saying' => 'If you can\'t fly, then run; if you can\'t run, then walk; if you can\'t walk, then crawl; but whatever you do you have to keep moving forward.','person' => 'Martin Luther King'),
  ...
  array('id' => '122','saying' => 'If you look at what you have in life, you\'ll always have more. If you look at what you don\'t have in life, you\'ll never have enough.','person' => 'Oprah Winfrey'),
  array('id' => '123','saying' => 'Imagination is more important than knowledge.','person' => 'Albert Einstein'),
  array('id' => '124','saying' => "Intelligence plus character – that is the goal of real education.",'person' => 'Martin Luther King'),
  ...
  array('id' => '143','saying' => "There are seven things that will destroy us: wealth without work; pleasure without conscience; knowledge without character; religion without sacrifice; politics without principle; science without humanity; business without ethics.",'person' => 'Mahatma Gandhi'),
  ...
  array('id' => '149','saying' => 'When we are saying this cannot be accomplished, this cannot be done, then we are short-changing ourselves. My brain, it cannot process failure. It will not process failure.','person' => 'Kobe Bryant'),
